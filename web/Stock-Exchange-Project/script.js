...
function getData(type, queryVar) {
  let url;
  if (type == "search") {
    // url = `https://financialmodelingprep.com/api/v3/search?query=${queryVar}&limit=10&exchange=NASDAQ&apikey=${process.env.API_KEY}`;
    // url = `https://financialmodelingprep.com/api/v3/search?query=${queryVar}&limit=1&exchange=NASDAQ&apikey=qcUtnRSssrsmSFksSYhDaPvCoowkGFAH`;
  } else if (type == symbol) {
    //  url = `https://financialmodelingprep.com//api/v3/company/profile/${queryVar}&apikey=${process.env.API_KEY}`;
    //  url = `https://financialmodelingprep.com//api/v3/company/profile/${queryVar}&apikey=qcUtnRSssrsmSFksSYhDaPvCoowkGFAH`;
  }
  //Mock data for development
  let data = [
    {
...
function getSymbol() {
  ...
  let allData = getData("symbol", symbol);

  // const url = `https://financialmodelingprep.com//api/v3/company/profile/${symbol}&apikey=${process.env.API_KEY}`;
  // const url = `https://financialmodelingprep.com//api/v3/company/profile/${symbol}&apikey=qcUtnRSssrsmSFksSYhDaPvCoowkGFAH`;
